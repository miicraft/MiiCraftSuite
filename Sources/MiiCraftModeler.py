...
class MiiCraftModeler:
    ...
    def draw_grid(self):
        ...
        self.x_axis_min_at0   = curve(pos=[(-22.5,-14,  0), (-22.5, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.x_axis_max_at0   = curve(pos=[( 22.5,-14,  0), ( 22.5, 14,  0)], radius=0.2, color=color.gray(0.5)) 
        self.x_axis_min_atH   = curve(pos=[(-22.5,-14,180), (-22.5, 14,180)], radius=0.2, color=color.gray(0.5))
        self.x_axis_max_atH   = curve(pos=[( 22.5,-14,180), ( 22.5, 14,180)], radius=0.2, color=color.gray(0.5)) 

        self.y_axis_min_at0   = curve(pos=[(-22.5,-14,  0), ( 22.5,-14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_max_at0   = curve(pos=[(-22.5, 14,  0), ( 22.5, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_min_atH   = curve(pos=[(-22.5,-14,180), ( 22.5,-14,180)], radius=0.2, color=color.gray(0.5))
        self.y_axis_max_atH   = curve(pos=[(-22.5, 14,180), ( 22.5, 14,180)], radius=0.2, color=color.gray(0.5))

        self.z_axis_LeftDown  = curve(pos=[(-22.5,-14,  0), (-22.5,-14,180)], radius=0.2, color=color.gray(0.5))
        self.z_axis_LeftUp    = curve(pos=[(-22.5, 14,  0), (-22.5, 14,180)], radius=0.2, color=color.gray(0.5))
        self.z_axis_RightDown = curve(pos=[( 22.5,-14,  0), ( 22.5,-14,180)], radius=0.2, color=color.gray(0.5))
        self.z_axis_RightUp   = curve(pos=[( 22.5, 14,  0), ( 22.5, 14,180)], radius=0.2, color=color.gray(0.5))

        self.x_axis_grid_m10  = curve(pos=[(-22.5,-10,  0), ( 22.5,-10,  0)], radius=0.2, color=color.gray(0.5))
        self.x_axis_grid_m5   = curve(pos=[(-22.5, -5,  0), ( 22.5, -5,  0)], radius=0.2, color=color.gray(0.5))
        self.x_axis_grid_0    = curve(pos=[(-22.5,  0,  0), ( 22.5,  0,  0)], radius=0.2, color=color.yellow)
        self.x_axis_grid_p5   = curve(pos=[(-22.5,  5,  0), ( 22.5,  5,  0)], radius=0.2, color=color.gray(0.5))
        self.x_axis_grid_p10  = curve(pos=[(-22.5, 10,  0), ( 22.5, 10,  0)], radius=0.2, color=color.gray(0.5))  

        self.y_axis_grid_m20  = curve(pos=[(  -20,-14,  0), (  -20, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_m15  = curve(pos=[(  -15,-14,  0), (  -15, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_m10  = curve(pos=[(  -10,-14,  0), (  -10, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_m5   = curve(pos=[(   -5,-14,  0), (   -5, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_0    = curve(pos=[(    0,-14,  0), (    0, 14,  0)], radius=0.2, color=color.yellow)        
        self.y_axis_grid_p5   = curve(pos=[(    5,-14,  0), (    5, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_p10  = curve(pos=[(   10,-14,  0), (   10, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_p15  = curve(pos=[(   15,-14,  0), (   15, 14,  0)], radius=0.2, color=color.gray(0.5))
        self.y_axis_grid_p20  = curve(pos=[(   20,-14,  0), (   20, 14,  0)], radius=0.2, color=color.gray(0.5))            
        ...
        if self.scene3D.mouse.events:
            ...
            if self.newy != self.lasty:
                ...
                if self.rangemin < newrange < self.rangemax:
                    ...
                    self.x_axis_min_at0.radius   = 0.01*newrange
                    self.x_axis_max_at0.radius   = 0.01*newrange                
                    self.x_axis_min_atH.radius   = 0.01*newrange  
                    self.x_axis_max_atH.radius   = 0.01*newrange
                    self.y_axis_min_at0.radius   = 0.01*newrange
                    self.y_axis_max_at0.radius   = 0.01*newrange                
                    self.y_axis_min_atH.radius   = 0.01*newrange  
                    self.y_axis_max_atH.radius   = 0.01*newrange               
                    self.z_axis_LeftDown.radius  = 0.01*newrange 
                    self.z_axis_LeftUp.radius    = 0.01*newrange  
                    self.z_axis_RightDown.radius = 0.01*newrange 
                    self.z_axis_RightUp.radius   = 0.01*newrange  
                        
                    self.x_axis_grid_m10.radius  = 0.01*newrange
                    self.x_axis_grid_m5.radius   = 0.01*newrange
                    self.x_axis_grid_0.radius    = 0.01*newrange
                    self.x_axis_grid_p5.radius   = 0.01*newrange                  
                    self.x_axis_grid_p10.radius  = 0.01*newrange  
        
                    self.y_axis_grid_m20.radius  = 0.01*newrange
                    self.y_axis_grid_m15.radius  = 0.01*newrange                
                    self.y_axis_grid_m10.radius  = 0.01*newrange
                    self.y_axis_grid_m5.radius   = 0.01*newrange
                    self.y_axis_grid_0.radius    = 0.01*newrange
                    self.y_axis_grid_p5.radius   = 0.01*newrange                  
                    self.y_axis_grid_p10.radius  = 0.01*newrange   
                    self.y_axis_grid_p15.radius  = 0.01*newrange
                    self.y_axis_grid_p20.radius  = 0.01*newrange                              
